          ...
          fetch(`/flight/ticket/api/${ref2}`)
            ...
            .then((ticket2) => {
              if (ticket2.status === "CONFIRMED") {
                document.querySelector(".section2 .flight2 .ref").innerText =
                  ticket2.ref;
                document.querySelector(".section2 .flight2 .from2").innerText =
                  ticket2.from;
                document.querySelector(".section2 .flight2 .to2").innerText =
                  ticket2.to;
